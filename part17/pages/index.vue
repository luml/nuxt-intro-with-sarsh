      ...
      <div class="container">
            ...
            >
              ...
              <g>
                ...
                <!-- <image
                  ...
                  :xlink:href="
                    'https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/' +
                      wineImg +
                      '.png'
                  "
        ...
        <aside>
          ...
          <div class="button-row">
            ...
            <button @click="wineFont = 'Cormorant Garamond'">
              Cormorant Garamond
            </button>
            <button @click="wineFont = 'IM Fell English'">
              IM Fell English
            </button>
            <button @click="wineFont = 'Londrina Shadow'">
              Londrina Shadow
            </button>
...
<script>
import appBlack from "./../components/black.vue";
export default {
  components: {
    appBlack: {
      template: "#black"
