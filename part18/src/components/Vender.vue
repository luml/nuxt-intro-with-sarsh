<template>
  <div class="wrapper">
    ...
    <div :style="{ display: isCheckingMachine ? 'block' : 'none'}" class="loading-state">
      <Machine />
    ...
    <section class="action-section" :style="{ filter: isRestocking ? 'contrast(0.5)' : 'none' }">
      <div class="supply">
      ...
      <div class="buttons">
        <button class="restock-btn" @click="restock" :disabled="supply === 40">Restock</button>
        <button class="dispense-btn" @click="dispense" :disabled="supply === 0">Dispense</button>
      </div>
    </section>
  </div>
</template>
